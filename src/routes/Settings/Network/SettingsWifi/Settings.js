...
import {
    WIFI_SETTINGS_CHANGE_TEXT,
    WIFI_SETTINGS_CHANGE_DROPDOWN,
    WIFI_SETTINGS_CHANGE_RADIOGROUP,
} from '../stores'
import ReactDropdown from 'react-dropdown'
import RadioButton from '../../../../components/common/RadioButton/RadioButton'

export const Settings = () => {
    const { dispatch, settingsWifi } = useStoreon('settingsWifi')

    const textSettings = settingsWifi.textSettings
    const dropdownSettings = settingsWifi.dropdownSettings
    const radioSettings = settingsWifi.radioSettings

    const onChangeRadio = (e) => {
        dispatch(WIFI_SETTINGS_CHANGE_RADIOGROUP, {
            name: e.target.name,
    ...
    const onChangeInput = (e) => {
        ...
        dispatch(WIFI_SETTINGS_CHANGE_TEXT, {
            name,
            value,
        })
    }
    return (
        <form
            onSubmit={(e) => {
                ...
                console.log(settingsWifi, 'saved settings')
            }}
            ...
            <div className="form-wrap">
                ...
                >
                    <ReactDropdown
                        ...
                        onChange={(e) => {
                            dispatch(WIFI_SETTINGS_CHANGE_DROPDOWN, {
