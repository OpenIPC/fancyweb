...
import {
    VTUN_SETTINGS_CHANGE_TEXT,
    VTUN_SETTINGS_CHANGE_DROPDOWN,
    VTUN_SETTINGS_CHANGE_RADIOGROUP,
} from '../stores'
import ReactDropdown from 'react-dropdown'
import RadioButton from '../../../../components/common/RadioButton/RadioButton'

export const Settings = () => {
    const { dispatch, settingsVtun } = useStoreon('settingsVtun')

    const textSettings = settingsVtun.textSettings
    const dropdownSettings = settingsVtun.dropdownSettings
    const radioSettings = settingsVtun.radioSettings

    const onChangeRadio = (e) => {
        dispatch(VTUN_SETTINGS_CHANGE_RADIOGROUP, {
            name: e.target.name,
    ...
    const onChangeInput = (e) => {
        ...
        dispatch(VTUN_SETTINGS_CHANGE_TEXT, {
            name,
            value,
        })
    }
    return (
        <form
            onSubmit={(e) => {
                ...
                console.log(settingsVtun, 'saved settings')
            }}
            ...
            <div className="form-wrap">
                ...
                >
                    <ReactDropdown
                        ...
                        onChange={(e) => {
                            dispatch(VTUN_SETTINGS_CHANGE_DROPDOWN, {
